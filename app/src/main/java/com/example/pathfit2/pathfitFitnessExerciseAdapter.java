...
public class pathfitFitnessExerciseAdapter extends RecyclerView.Adapter<pathfitFitnessExerciseAdapter.CardViewHolder> {
    ...
    public pathfitFitnessExerciseAdapter(Context context, ArrayList<fitnessExerciseCardItem> cardItemList) {
    ...
    public CardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context)
                .inflate(R.layout.pathfit_fitness_cardview, parent, false);
    ...
    public void onBindViewHolder(@NonNull CardViewHolder holder, int position) {
        ...
        fitnessExerciseCardItem cardItem = cardItemList.get(position);
