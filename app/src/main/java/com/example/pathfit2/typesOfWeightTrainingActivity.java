...
public class typesOfWeightTrainingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_types_of_weight_training);
        ...
        recyclerView = findViewById(R.id.recyclerWeightTraining);
    ...
    public void toolbarIconsAction(){
        ...
        backIcon.setOnClickListener(v -> {
            ...
            Intent intent =  new Intent(typesOfWeightTrainingActivity.this, healthRelatedLesson.class);
            startActivity(intent);
        });
        nextIcon.setOnClickListener(v -> {
            Intent intent =  new Intent(typesOfWeightTrainingActivity.this, principlesOfCardio.class);
            startActivity(intent);
        });
