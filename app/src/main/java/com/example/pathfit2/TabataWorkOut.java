...
public class TabataWorkOut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tabata_work_out);
        ...
        recyclerView = findViewById(R.id.recyclerTabataWorkout);
    ...
    public void toolbarIconsAction() {
        ...
        backIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TabataWorkOut.this, StretchingAndFlexibility.class);
        ...
        nextIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TabataWorkOut.this, SevenMinWorkout.class);
                startActivity(intent);
            }
        });
