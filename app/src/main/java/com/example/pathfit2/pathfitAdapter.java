...
public class pathfitAdapter extends RecyclerView.Adapter<pathfitAdapter.CardViewHolder> {
    ...
    public pathfitAdapter(Context context, ArrayList<pathfitCardItem> cardItemList) {
